export function LectorCard({ lector }: { lector: any }) {
  return (
    <div className="w-[80vw] h-[70vh]  rounded-2xl bg-background-primary shadow-white grid grid-cols-3">
      <div className="w-full h-full col-span-1">
        <img src={lector.image} className="object-cover h-full rounded-l-2xl" />
      </div>
      <div className="col-span-2 p-5 text-text-secondary flex flex-col gap-2.5">
        <h2>{lector.name}</h2>
